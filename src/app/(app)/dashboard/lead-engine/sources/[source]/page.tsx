...
import { LeadSourceWorkspace } from "@/app/lead-engine/LeadSourceWorkspace";
import { getLeadSource, leadSources } from "@/app/lead-engine/source-data";
...
export async function generateMetadata({
  ...
  return {
    title: source ? `${source.label} · Lead Engine` : "Source Not Found · Lead Engine",
