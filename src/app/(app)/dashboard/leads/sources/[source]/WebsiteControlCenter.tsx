...
export function WebsiteControlCenter({ asset, leadCount, hotLeadCount }: WebsiteControlCenterProps) {
  ...
  return (
    <section className={assetStyles.controlCenter} aria-label={`${asset.name} website controls`}>
      <div className={assetStyles.controlCenterHead}>
        <div>
        ...
        <div className={assetStyles.controlHealth}>
          <span className={asset.status === "active" ? assetStyles.healthDotGood : assetStyles.healthDotWarn} />
      ...
      <nav className={assetStyles.managerNav} aria-label="Website manager sections">
      ...
      <div className={assetStyles.managerModules}>
        <article className={assetStyles.managerModule} id="site-production">
          <div className={assetStyles.moduleTitle}><span><Rocket size={15} /></span><div><strong>Production & deployments</strong><small>Live environment and release controls</small></div></div>
          <div className={assetStyles.moduleMetrics}>
          ...
          <div className={assetStyles.moduleActions}>
        ...
        <article className={assetStyles.managerModule}>
          <div className={assetStyles.moduleTitle}><span><Code2 size={15} /></span><div><strong>Source code</strong><small>Repository and release source</small></div></div>
          <div className={assetStyles.moduleMetrics}>
        ...
        <article className={assetStyles.managerModule} id="site-seo">
          <div className={assetStyles.moduleTitle}><span><Search size={15} /></span><div><strong>Pages & SEO</strong><small>Indexability and search controls</small></div></div>
          <div className={assetStyles.moduleMetrics}>
        ...
        <article className={assetStyles.managerModule} id="site-performance">
          <div className={assetStyles.moduleTitle}><span><Gauge size={15} /></span><div><strong>Performance & quality</strong><small>Speed, experience and technical health</small></div></div>
          <div className={assetStyles.moduleMetrics}>
        ...
        <article className={assetStyles.managerModule}>
          <div className={assetStyles.moduleTitle}><span><MousePointerClick size={15} /></span><div><strong>Lead capture</strong><small>Conversion and acquisition flow</small></div></div>
          <div className={assetStyles.moduleMetrics}>
        ...
        <article className={assetStyles.managerModule} id="site-integrations">
          <div className={assetStyles.moduleTitle}><span><Link2 size={15} /></span><div><strong>Integrations</strong><small>Services that power this website</small></div></div>
          <div className={assetStyles.integrationRows}>
        ...
        <article className={assetStyles.managerModule}>
          <div className={assetStyles.moduleTitle}><span><ShieldCheck size={15} /></span><div><strong>Security</strong><small>Public-site protection and access</small></div></div>
          <div className={assetStyles.securityRows}>
          ...
          <div className={assetStyles.moduleActions}><Link href="/dashboard/connect"><LockKeyhole size={13} /> Security connections</Link></div>
        </article>

        <article className={assetStyles.managerModule} id="site-settings">
          <div className={assetStyles.moduleTitle}><span><Settings2 size={15} /></span><div><strong>Website settings</strong><small>Identity, source state and ownership</small></div></div>
          <div className={assetStyles.moduleMetrics}>
          ...
          <div className={assetStyles.moduleActions}><a href="#website-edit"><Settings2 size={13} /> Edit website settings</a></div>
        </article>
      </div>
    </section>
  );
