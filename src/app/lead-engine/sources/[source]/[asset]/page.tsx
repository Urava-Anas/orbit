...
import { SourceAssetWorkspace } from "../../../SourceAssetWorkspace";
import { getLeadSource, getSourceAsset, leadSources } from "../../../source-data";
...
export async function generateMetadata({
  ...
  return {
    title: source && asset ? `${asset.name} — ${source.label} Control` : "Asset Not Found — Lead Engine",
