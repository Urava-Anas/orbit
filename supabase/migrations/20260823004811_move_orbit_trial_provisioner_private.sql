...
revoke all on function private.start_orbit_trial(text) from public;
grant execute on function private.start_orbit_trial(text) to authenticated, service_role;
...
revoke all on function public.start_orbit_trial(text) from public, anon;
