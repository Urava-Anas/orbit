-- Preserve the production mailbox-state fix: resolve the active Apex workspace
-- from the signed-in user's authorized email before returning credential flags.
